...
#define STRING_CONFIG_H_AUTHOR "(Jake Gustafson, BTT SKR V1.4 Turbo + TFT35 for Replicator 2X but with thermistors)" // Who made the changes.
...
// #define USE_ZMIN_PLUG // commented out as per BLTouch Smart V3.1 manual
...
> - Hey once again, what about z axis then? – Anton Osadchy Mar 7 '16 at 17:47
> - Z is 400 steps/mm. (8mm lead, 1/16 microstepping, 200 steps/mm motor.) Sidenote, make sure you don't over-drive the Z stepper with plug-in drivers, it's only rated to about 0.4A. – Ryan Carlyle Mar 7 '16 at 19:15
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 200, 10000, 10000 }
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // commented as per the BLTouch Smart V3.1 manual
...
// This Axle Media setting (4*60 based on HOMING_FEEDRATE_MM_M--The old setting was formerly HOMING_FEEDRATE_Z) became the new default coincidentally (The default changed somewhere between CONFIGURATION_H_VERSION 020008 and 02000901)
...
#define AUTO_BED_LEVELING_BILINEAR // specified in the BLTouch Smart V3.1 manual
